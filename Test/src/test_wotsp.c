...
static unsigned char const exp_y[SPHINCS_BYTES*WOTS_L] = {
...
static char const * test_wotsp_verify(void)
{
	...
	/* Checks correctness of in1_hashed_256 signature */
	mu_assert("Signature should be valid.", wotsp_verify(in1_hashed_256, exp_y, sig, in_masks));
