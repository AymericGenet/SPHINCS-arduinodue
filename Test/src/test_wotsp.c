...
{
	unsigned char const in_sk1[SEED_BYTES] = {
	...
	unsigned char const in_masks[MASKS_BYTES] = {
...
static char const * test_wotsp_verify(void)
{
	...
	unsigned char const sig[WOTS_L*SPHINCS_BYTES] = {
		...
		/* sig_64 */
		0x80, 0x19, 0x10, 0x1c, 0x8f, 0x5a, 0x7e, 0x82,
		0x22, 0x65, 0x4d, 0x8b, 0xc9, 0xfb, 0x05, 0xbf,
		0x5e, 0x6c, 0xb7, 0xc9, 0x19, 0x79, 0x3a, 0xb0,
		0x8c, 0x62, 0x4c, 0x07, 0x19, 0xf5, 0xd5, 0xe8,
		...
		/* sig_66 */
		0x15, 0x0a, 0x00, 0x7a, 0x6b, 0xb7, 0x09, 0x72,
		0x0d, 0xea, 0xbc, 0x04, 0xe4, 0x3b, 0x59, 0xe1,
		0x0d, 0xaa, 0xd1, 0xda, 0xd6, 0x5d, 0x6c, 0xfd,
		0x73, 0x44, 0x2f, 0x66, 0x85, 0xaf, 0xa4, 0xe3
	};
	unsigned char const in_masks[MASKS_BYTES] = {
		0x61, 0x6e, 0x61, 0x69, 0x6c, 0x6c, 0x65, 0x2c,
		0x20, 0x41, 0x20, 0x62, 0x69, 0x6e, 0x20, 0x66,
